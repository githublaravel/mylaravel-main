...
@section('body')
    <div class="container position-absolute top-50 start-50 translate-middle">
        <div class="row">
            <div class="col-md-6 col-12 border-1 rounded-end" style="height: 40rem">
                <div class="form-container position-absolute top-50 start-50 translate-middle"
                    ...
                    <form class="form">
                        <input type="text" class="input" placeholder="نام کاربری" required>
                        <input type="email" class="input" placeholder="ایمیل" required>
                        <input type="password" class="input" placeholder="رمز عبور" required>
                        <input type="password" class="input" placeholder="تکرار رمز عبور" required>
                        <p class="page-link">
                            <span class="page-link-label">رمز عبور را فراموش کرده‌اید؟</span>
                        </p>
                        <button class="form-btn">ثبت نام</button>
                    </form>
                    <p class="sign-up-label">
                        ورود به حساب کاربری:<a href="http://127.0.0.1:8000/auth/login"><span class="sign-up-link">ورود</span></a>
                    </p>
