...
@section('body')
    ...
    <div class="container-fluid top-slider-con rounded">
        <div class="container">
            <div class="row">
                <!-- Main carousel -->
                <div class="col-md-12 p-1">
                    <div id="carouselExampleControls" class="carousel slide border rounded" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset('image/slider/s1.jpg') }}" class="d-block w-100" alt="...">
                                <div
                                    class="position-absolute bottom-0 start-50 translate-middle bg-dark text-white p-3 rounded">
                                    Welcome
                                </div>
                            </div>
            ...
            <!-- Smaller carousels stacked vertically -->
            <div class="row">
                <div class="col-md-6 col-6 p-1">
                    <!-- First smaller carousel -->
                    <div id="carouselExampleSlidesOnly1" class="carousel slide rounded-2 border" data-bs-ride="carousel">
                ...
                <div class="col-md-6 col-6 p-1">
                    <!-- Second smaller carousel -->
                    <div id="carouselExampleSlidesOnly2" class="carousel slide rounded-2 border" data-bs-ride="carousel">
                        <div class="carousel-inner n-control">
                            <div class="carousel-item active">
                                <img src="{{ asset('image/slider/s1.jpg') }}" class="d-block w-100" alt="...">
                            </div>
    ...
    <div class="container p-1">
        <div class="row p-1 row-article" style="margin: auto">
            ...
            <div class="row" style="margin: auto">
                <h4 class="title"><select class="category-select rounded-1">
                        <option>
                            اخبار روز دنیا
                        </option>
                        <option>cat-2</option>
    ...
    <div class="container-fluid ques-slider rounded">
        <div class="container">
            <div class="row p-1" style="margin: auto">
                            ...
                            <ul class="splide__list">
                                @for ($i = 0; $i < 6; $i++)
                                    <li class="splide__slide">
                                        <div class="card-body bg-light rounded card-ques">
                ...
                <div class="col-12 col-md-2 col-cat">
                    <div class="card border-success mb-3 card-ques" style="max-width: 18rem;">
            ...
            <div class="row p-1" style="margin: auto">
                ...
                <div class="col-12 col-md-2">
                    <div class="card border-success mb-3 card-ques" style="max-width: 18rem;height: 100%">
                        <div class="card-header bg-transparent border-success">
